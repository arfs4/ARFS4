...
/obj/away_mission_init/beachcave/initialize()
	...
	/*seed_submaps(list(z), 50, /area/endeavor_away/cave/unexplored/normal, /datum/map_template/surface/mountains/normal)
	seed_submaps(list(z), 50, /area/endeavor_away/cave/unexplored/deep, /datum/map_template/surface/mountains/deep)
